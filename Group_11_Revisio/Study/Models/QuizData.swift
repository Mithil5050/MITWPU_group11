    ...
    static let quizDataBySource: [String: [QuizQuestion]] = [
        ...
        "Taylor Series PDF": [
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "It involves the function's value and its derivatives at the center point 'a'."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "Remember the derivative of e^x is e^x."
            ),
            QuizQuestion(
        ...
        "Prof. Leonard Channel": [
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "The rule applies only to specific fractional forms of limits."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "The LIATE rule often helps select 'u' in this technique."
            ),
            QuizQuestion(
        ...
        "Derivative Rules Cheat": [
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "A constant has no rate of change."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "Remember 'low d high minus high d low...'"
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "Its derivative retains the positive co-function."
            )
        ],
        ...
        "Hadoop Docs": [
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "Hadoop is known for large-scale distributed storage."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "Think of the operating system of the Hadoop cluster."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "This factor determines data fault tolerance."
            )
        ],
        ...
        "Assembly Guide": [
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "The mnemonic stands for 'Move'."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "It changes the program counter directly without checking a flag."
            ),
            QuizQuestion(
                ...
                userAnswerIndex: nil,
                isFlagged: false,
                hint: "It corresponds directly to machine code."
            )
        ]
    ]
